...
df = pd.merge(df_empdep, df_rev, how='inner',
              left_on='dname', right_on='dname')

print('Original DF:')
print(df)

# Delete unneeded columns
df.drop(['id_y', 'id', 'image', 'phone1', 'phone2',
        'dep', 'email'], inplace=True, axis=1)
print('Pruned DF:')
print(df)

# Rename columns
df.columns = ['Id', 'Etunimi', 'Sukunimi', 'Palkka',
              'Syntymäaika', 'Osasto', 'Osaston tulos']
